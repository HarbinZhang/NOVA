...
public class SignupActivity extends AppCompatActivity {
    ...
    private String[] hospitalsName = {"Spectrum Health", "Henry Ford Health System", "UM Health System"};
    private String[] hospitalsUrl = {"https://myhealth.spectrumhealth.org/#/", "https://mychart.hfhs.org/mychart/", "https://www.myuofmhealth.org/MyChart-PRD/"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner = (Spinner) findViewById(R.id.sp_signup_hospital);

        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, hospitalsName);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                userchoice = position;
                editor.putString("hospitalUrl", hospitalsUrl[position]);
                editor.apply();
            }
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    try{
                                        ...
                                        mDatabase.child("users").child(mUserId).child("hospitalName").setValue(hospitalsName[userchoice]);
                                        mDatabase.child("users").child(mUserId).child("hospitalUrl").setValue(hospitalsUrl[userchoice]);

                                        mDatabase.child("users").child(mUserId).child("reminders").child("info").setValue(null);
                                        mDatabase.child("users").child(mUserId).child("reminders").child("eaten").setValue(null);
