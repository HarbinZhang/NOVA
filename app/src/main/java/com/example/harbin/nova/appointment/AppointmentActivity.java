...
import com.example.harbin.nova.MainActivity;
        ...
        confirmBuilder.setMessage("Are you sure to cancel this appointment?")
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        dialog.cancel();
                        finish();
                        Toast.makeText(mContext, "Cancel appointments successful", Toast.LENGTH_LONG).show();
...
//                getWeekView().notifyDatasetChanged();
        ...
        availableHourQuery.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                confirmBuilder.setMessage("The doctor is available during " + availableTime.startTime + ":00 to " +
                                        availableTime.endTime + ":00.")
                        .setCancelable(false)
