...
public class SelectRemindCyclePopup implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        }else if(id == R.id.tv_drugcycle_2) {
        ...
        }else if(id == R.id.tv_drugcycle_3) {
        ...
        }else if(id == R.id.tv_drugcycle_4) {
        ...
        }else if(id == R.id.tv_drugcycle_5) {
        ...
        }else if(id == R.id.tv_drugcycle_6) {
        ...
        }else if(id == R.id.tv_drugcycle_7) {
